						...
						<td class="product-quantity">
							<?php
								if ( $_product->is_sold_individually() ) {
									...
									$product_quantity = sprintf( '<div class="quantity"><input name="cart[%s][qty]" data-min="%s" data-max="%s" value="%s" size="4" title="Qty" class="input-text qty text" maxlength="12" /></div>', $cart_item_key, $min, $max, esc_attr( $values['quantity'] ) );
								}
