...
$yiw_options['general'] = array (
    ...
    'select-skin' => array(    
        ...
        array( 'name' => __('Theme skin', 'yiw'),
        	   'desc' => __('Theme shared on W P L O C K E R . C O M - Select the skin you want to use in this theme. NB: if you want to change the skin, select it before continue.', 'yiw'),
    ...
    'linksbar' => array(
        ...
        array( 'name' => __('Show Sign in link', 'yiw'),
        	   'desc' => __('Select if you want to show the "Sign in" link on bar of links.', 'yiw'),
        	   'id' => 'show_linksbar_signin',     
        	   'type' => 'on-off',  
        	   'deps' => array(
			   		'id' => 'show_linksbar',
			   		'value' => 1
...
*/
    ...
    'shop' => array(
		...
		array( 'name' => __('Custom Related Products number', 'yiw'),
        	   'desc' => __('Select if you want to customize the number of Related Products. Note: if you are already using a custom filter to do that, please don\'t enable this option.', 'yiw'),
